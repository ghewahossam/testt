...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-primary" href="<?php echo e(route('appointment_list')); ?>">Back</a>
        </div>
    </div>
                        ...
                        <form id="form">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8 col-md-12">
                                    <input type="text" class="form-control" name="name" value="<?php echo e($appointment->name); ?>">
                                    <input type="text" class="form-control" name="id" hidden value="<?php echo e($appointment->id); ?>">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8 col-md-12">
                                    <textarea name="description" class="form-control" id="" cols="30" rows="5"><?php echo e($appointment->description); ?></textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-sm-8 col-md-12">
                                        <input type="text" class="form-control" name="date" id="date" value="<?php echo e($appointment->date); ?>">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-sm-8 col-md-12">
                                        <input type="text" class="form-control" name="time" id="time" value="<?php echo e($appointment->time); ?>">
    ...
    <script>
        $('#form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('appointment_update_post')); ?>",
                data: formData,
                beforeSend: function() {
                ...
                success: function(data) {
                    if (data.status) {
                        window.location.href = "<?php echo e(route('appointment_list')); ?>";
...
<?php echo $__env->make('Dashbord.layout.App', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\غوى\clinicians\resources\views/Dashbord/appointment/edit.blade.php ENDPATH**/ ?>