...
<?php $__env->startSection('content'); ?>
    <div class="pagetitle">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                <a class="btn btn-primary" href="<?php echo e(route('user_createnew')); ?>"> Create new User</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    type: 'post',
                    url: "<?php echo e(route('user_list_post')); ?>",
                    beforeSend: function() {
...
<?php echo $__env->make('Dashbord.layout.App', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\غوى\clinicians\resources\views/Dashbord/User/index.blade.php ENDPATH**/ ?>